...
- `coef.sc_hplm()`: new `casewise` argument f. If set TRUE, returns the effect estimatinons casewise.
- `print.sc_hplm()`: new `casewise` argument f. If set TRUE, returns the effect estimatinons casewise.
- `export.sc_hplm()`: new `casewise` argument f. If set TRUE, returns the effect estimatinons casewise.
