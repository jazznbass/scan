...
#' 
#' Kendalls tau correlation for the dependent variable and the phase variable 
...
#' are checked for a significant autocorrelation (based on Kendalls Tau). 
#' If so, a non-parameteric Theil-Sen regression is applied for the baseline 
...
#' Finally, Kendalls tau is calculated for the dependent variable and the 
...
#' \code{continuity = TRUE} (both are the default settings).
#' 
